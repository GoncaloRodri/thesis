...
As shown previously in \autoref{sec:motivation}, Tor is a widely used anonymity network that provides users privacy and security while browsing the internet. However, Tor is not immune to attacks [REFS ABOUT THIS] 
\begin{figure}
  \centering
