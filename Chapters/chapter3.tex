...
\begin{itemize}
  ...
  \item\textbf{Web Browsing: } In this scenario, we consider that it is important to evaluate performance measurements over a scenario where high performance is required, such as web browsing. This scenario will have a high number of small sized requests and responses. 
