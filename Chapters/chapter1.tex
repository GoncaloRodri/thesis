...
Nowadays, data is a valuable asset with multiple uses. With various entities seeking this data, some for questionable reasons, it is essential to allow people to surf the web with trustworthy methods that preserve their privacy and anonymity whilst maintaining good throughput and latency conditions. 
