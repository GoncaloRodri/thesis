...
We take inspiration in the work of~\citeauthor{KIST}~\cite{KIST}, which proposed a congestion control scheduler for Tor that improves the network's performance by reducing latency and increasing throughput. However, KIST focus on performance improvements, and does not provide privacy guarantees nor traffic analysis attacks resistance, besides the ones already provided by Tor. Therefore, we take this work as a starting point to develop our solution, which aims to keep the conditions and improvements proposed by KIST, while adding privacy guarantees and resistance to traffic analysis attacks.

With this solution, we are able to reinforce the Tor end-to-end communication anonymity guarantees, even under traffic fingerprinting and correlation attacks. To ensure real-world applicability of this solution, it is important to maintain practical levels of throughput and latency for end-to-end communication. 
