...
Freedom of speech and access to information are fundamental rights that must people take for guaranted. However, in some regions of the world, these rights are denied due to powerful and oppressive regimes and state level adversaries with access to vast resources that control the flow of infomration and restrict the access to the internet, in order to control the population~\cite*{aryan2013internet, zittrain2017shifting, alimardani2018internet}. 
...
Fingerprinting attacks also represent a major threat to Anonymity Networks, as they allow attackers to learn information about user's online activities, even on encrypted traffic, by eavesdropping and collecting side-channel infomration, between the user and the entry node. 
