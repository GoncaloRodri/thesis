...
Ligamo-nos diariamente à Internet, tendo acesso a um fluxo avassalador de informações sobre o mundo. A liberdade de expressão é um direito essencial, assumido como parte inquestionável do nosso quotidiano. No entanto, este direito é negado por regimes autoritários e entidades que controlam o fluxo de informação, a fim de manter o poder e o controlo sobre os seus cidadãos. Estas forças têm vindo a desenvolver continuamente os seus métodos e recursos para aplicar essas políticas opressivas de forma mais eficaz. 
Por essa razão, é crucial garantir que aqueles que vivem sob tal opressão tenham acesso às ferramentas e conteúdos que lhes são negados e disponham dos meios para comunicar livremente, em segurança e sem medo.

Para fazer face a este desafio, pretendemos desenvolver uma rede de comunicação, sobre a rede Tor, capaz de contrariar ataques de correlação de última geração para garantir o anonimato e a privacidade dos utilizadores.
Ao incorporar os princípios da Privacidade Diferencial, a solução introduz ruído cuidadosamente calibrado no fluxo de tráfego e assegura garantias de privacidade robustas e formalmente comprovadas, distinguindo-se das soluções que se baseiam em testes práticos. Além disso, a Privacidade Diferencial também fornece controlos de privacidade personalizáveis e ajustáveis, permitindo que os utilizadores equilibrem o compromisso entre privacidade e utilidade de acordo com as suas necessidades.
