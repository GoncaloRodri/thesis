...
\begin{table}[h!]
    ...
    \begin{tabular}{|c|p{5cm}|c|p{6cm}|}
        ...
        \maintask{1}{Revision \& Consilidation of Elaboration Guidelines}{}
        \subtask{1.1}{System Model \& Evaluation}{-}{Revision of the System Model}
        \subtask{1.2}{Initial Specification of Components}{1.1}{Consilidation of the Components Specification}
        ...
        \subtask{5.1}{Consilidation}{4.1}{Consilidation of Phases 1 and 2 Prototypes}
