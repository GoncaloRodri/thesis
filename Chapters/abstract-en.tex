...
We connect to the internet daily, gaining access to an overwhelming flow of information about the world. However, some of the most dramatic and impactful news—especially rare reports from regions often absent from our usual feeds—rely on anonymous sources. These reports frequently emerge from places known for limited freedom of speech and oppressive conditions, making their very existence both precarious and vital. This information come from individuals who risk their lives to share their stories, often relying on anonymity networks to protect their identities and ensure their safety. With the vast resources and power of the prosecutors, often totalitarian regimes, need for robust, secure and privacy-preserving is more critical than ever.

To tackle this challenge, we aim to develop a communication network, on top of Tor network, capable of countering state-of-the-art correlation attacks to ensure user anonymity and privacy, all while maintaining practical levels of throughput and latency. By integrating differential privacy principles, this work aims to inject calibrated noise into traffic flows and statistical communication patterns, maintaining high privacy guarantees, even under advanced traffic analysis and censorship attacks.
